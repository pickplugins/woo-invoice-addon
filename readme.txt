...
### WooCommerce Invoice by [http://pickplugins.com](http://pickplugins.com)
...
2. Go your plugin setting via WordPress Dashboard and find "<strong>Woocommerce Invoice</strong>" activate it.<br />
